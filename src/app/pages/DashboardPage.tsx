        ...
        <div className="space-y-6">
            ...
            <span className="bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text text-transparent">
              Panel de Control
                ...
                <Button
                    ...
                    className="bg-gradient-to-r from-blue-600 to-blue-700 shadow-lg transition-all duration-200 cursor-pointer hover:brightness-110
                                hover:shadow-2xl hover:-translate-y-[2px] active:scale-95">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <Link to="/services?status=pending" className="block h-full">
                    <Card
                        className="interactive-card interactive-card-overlay border-0 shadow-xl ring-2 ring-orange-300/40 bg-gradient-to-br from-orange-400 to-orange-500 text-white overflow-hidden relative h-full">
                        ...
                        <CardContent className="relative z-10">
                            ...
                            <div className="mt-1 space-y-1">
                                ...
                                {stats.highPriority > 0 && (
                                    <span
                                        className="text-xs bg-red-500/90 text-white px-2 py-0.5 rounded-full font-medium">
                ...
                <Link to="/services?status=in-progress" className="block h-full">
                    <Card
                        className="interactive-card interactive-card-overlay border-0 shadow-lg bg-gradient-to-br from-blue-500 to-blue-600 text-white overflow-hidden relative h-full">
                        <div className="absolute top-0 right-0 w-24 h-24 bg-white/10 rounded-full -mr-8 -mt-8"/>
                        <CardHeader className="flex flex-row items-center justify-between pb-2 relative z-10">
                ...
                <Link to="/services?status=completed&period=month" className="block h-full">
                    <Card
                        className="interactive-card interactive-card-overlay border-0 shadow-lg bg-gradient-to-br from-emerald-500 to-green-600 text-white overflow-hidden relative h-full">
                        <div className="absolute top-0 right-0 w-24 h-24 bg-white/10 rounded-full -mr-8 -mt-8"/>
                        <CardHeader className="flex flex-row items-center justify-between pb-2 relative z-10">
                ...
                <CardHeader className="bg-gradient-to-r from-gray-50 to-blue-50/50 border-b">
                    <div className="flex items-center justify-between">
                        ...
                        <Button
                            ...
                            className="transition-all duration-200 cursor-pointer hover:bg-gray-200 hover:shadow-md hover:-translate-y-[1px] active:scale-95">
                            Ver Todos
